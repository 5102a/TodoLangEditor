...
if (!Object.getOwnPropertyDescriptor(Module["ready"], "_eval")) {
 Object.defineProperty(Module["ready"], "_eval", {
  configurable: true,
  get: function() {
   abort("You are getting _eval on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
 Object.defineProperty(Module["ready"], "_eval", {
  configurable: true,
  set: function() {
   abort("You are setting _eval on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js");
  }
 });
}
...
function __asyncjs__do_wait() {
 return Asyncify.handleAsync(async () => {
  ...
  globalThis.wasmModule.stringToUTF8(response, ret, len);
  return ret;
 });
}
...
var Asyncify = {
 ...
 instrumentWasmImports: function(imports) {
  var ASYNCIFY_IMPORTS = [ "env.do_wait", "env.invoke_*", "env.emscripten_sleep", "env.emscripten_wget", "env.emscripten_wget_data", "env.emscripten_idb_load", "env.emscripten_idb_store", "env.emscripten_idb_delete", "env.emscripten_idb_exists", "env.emscripten_idb_load_blob", "env.emscripten_idb_store_blob", "env.SDL_Delay", "env.emscripten_scan_registers", "env.emscripten_lazy_load_code", "env.emscripten_fiber_swap", "wasi_snapshot_preview1.fd_sync", "env.__wasi_fd_sync", "env._emval_await", "env._dlopen_js", "env.__asyncjs__*" ].map(x => x.split(".")[1]);
...
var asmLibraryArg = {
 ...
 "__asyncjs__do_wait": __asyncjs__do_wait,
